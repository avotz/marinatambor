...
gulp.task('js', function () {
  gulp.src([
     ...
     // './assets/js/vendor/imagesloaded.min.js',
      ...
      './assets/js/vendor/TimelineMax.min.js',
      
      './assets/js/vendor/ScrollMagic.min.js',
      './assets/js/vendor/animation.gsap.min.js',
...
gulp.task('css', function () {
  gulp.src(['./assets/css/main.css', './assets/css/magnific-popup.css','./assets/css/slick.css','./assets/css/animate.css'])
...
gulp.task('watch', function () {
    ...
    gulp.watch('./assets/stylus/**/*.styl',gulp.parallel(['stylus']));
...
gulp.task('default', gulp.parallel('js','stylus','css','browser-sync', 'watch'));
