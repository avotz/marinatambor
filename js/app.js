...
__webpack_require__(/*! ./vendor/jquery.magnific-popup.min.js */ "./resources/js/vendor/jquery.magnific-popup.min.js");

__webpack_require__(/*! ./vendor/smooth-scrollbar.js */ "./resources/js/vendor/smooth-scrollbar.js");
...
(function ($) {
  ...
  var Scrollbar = window.Scrollbar; //Scrollbar.init(document.querySelector('.scroll-wrapper'));
  ...
  if (isHome()) {
    ...
    var showIntroDescriptionAnim = new gsap__WEBPACK_IMPORTED_MODULE_1__["TimelineMax"]();
    var hideIntroDescriptionAnim = new gsap__WEBPACK_IMPORTED_MODULE_1__["TimelineMax"]();
    var ChangeBGColorIntroAnim = new gsap__WEBPACK_IMPORTED_MODULE_1__["TimelineMax"]();
    showIntroDescriptionAnim.to('.banner-title h3', .2, {
      opacity: 1,
      color: '#254E7B',
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Linear"].easeNone
    });
    showIntroDescriptionAnim.to('.banner-title p', .3, {
      opacity: 1,
      color: '#444',
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Linear"].easeNone
    });
    hideIntroDescriptionAnim.to('.banner-title', .3, {
      opacity: 0,
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Linear"].easeNone
    ...
    }).addTo(controller).setTween(showIntroDescriptionAnim);
    var scene2 = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
      triggerElement: ".services",

      /*duration:450*/
      triggerHook: 'onEnter',
      offset: 360
    }).addTo(controller).setTween(hideIntroDescriptionAnim);
    var scene3 = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
      triggerElement: ".services",

      /*duration:400,*/
      triggerHook: 'onEnter',
      offset: 203
    }).addTo(controller).setTween(gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(".page-bg", .5, {
      opacity: 0,
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Linear"].easeNone
    }));
    var scene4 = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
      triggerElement: ".services",
      triggerHook: 'onCenter'
    }).addTo(controller) //.setTween(ChangeBGColorIntroAnim);
    .setTween(gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo(".services-item", .5, {
      top: '0',
      opacity: 1,
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Linear"].easeNone
    }, 0.25));
    var scene5 = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
      triggerElement: ".case",
      triggerHook: 'onEnter',
      offset: 203
    }).addTo(controller) //.setTween(ChangeBGColorIntroAnim);
    .setTween(gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(".page-bg", .5, {
      opacity: 1,
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Linear"].easeNone
    }));
    var scene6 = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
      triggerElement: ".case",
      duration: 400,
      triggerHook: 'onEnter',
      offset: 203
    }).addTo(controller) //.setTween(ChangeBGColorIntroAnim);
    .setTween(gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(".parallax", 1, {
      y: '-20%',
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Linear"].easeNone
    }));
    var scene7 = new scrollmagic__WEBPACK_IMPORTED_MODULE_0___default.a.Scene({
      triggerElement: ".case",

      /*duration:100 ,*/
      triggerHook: 'onEnter',
      offset: 303
    }).addTo(controller).setTween(gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo(".case-info-item", .5, {
      left: '0',
      opacity: 1,
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Linear"].easeNone
    }, 0.25));
...
/***/ "./resources/js/vendor/smooth-scrollbar.js":
/*!*************************************************!*\
  !*** ./resources/js/vendor/smooth-scrollbar.js ***!
  \*************************************************/
/*! no static exports found */
...
!function (t, n) {
  ...
  return function (t) {
    ...
    t.exports = function (t, n, e, v, y, m, g) {
      ...
      if (j && (_ = l(j.call(new t()))) !== Object.prototype && _.next && (f(_, S, !0), r || c(_, p) || u(_, p, d)), E && M && "values" !== M.name && (O = !0, A = function A() {
        return M.call(this);
    ...
    function l(t) {
      return "symbol" == _typeof(t) || vt(t) && dt(t) == yt;
    }
...
__webpack_require__(/*! G:\laragon\www\marinatambor\wp-content\themes\marinatambor\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! G:\laragon\www\marinatambor\wp-content\themes\marinatambor\resources\stylus\main.styl */"./resources/stylus/main.styl");
