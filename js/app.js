...
function () {
  ...
  _proto.initListeners = function initListeners() {
    ...
    this.resizeObserver = new resize_observer_polyfill__WEBPACK_IMPORTED_MODULE_14__["default"](function () {
      ignoredCallbacks++;
...
(function ($) {
  ...
  var iteractiveMap = $('.interactive-map .map');
  var mapLinks = document.querySelectorAll('.map-links .map-button');
  mapLinks.forEach(function (element) {
    hoverintent(element, function () {
  ...
  $(".circle-main").mouseup(function (e) {
    $("<div class='circle-pulse'></div>").appendTo(".circle-main").delay(1100).queue(function () {
      $(this).remove();
    });
  });
